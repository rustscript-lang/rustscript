...
/// Host function `websocket::connection::set_subprotocols`.
...
/// Host function `websocket::connection::send_binary`.
#[pd_host_function(name = "websocket::connection::send_binary")]
fn websocket_connection_send_binary(connection: i64, payload: Bytes) -> i64 {
    unreachable!("abi declaration only")
}

/// Host function `websocket::connection::read_binary_base64`.
...
/// Host function `websocket::connection::read_binary`.
#[pd_host_function(name = "websocket::connection::read_binary")]
fn websocket_connection_read_binary(connection: i64) -> Bytes {
    unreachable!("abi declaration only")
}

/// Host function `websocket::connection::eof`.
#[pd_host_function(name = "websocket::connection::eof")]
fn websocket_connection_eof(connection: i64) -> bool {
    unreachable!("abi declaration only")
}

/// Host function `websocket::connection::close`.
