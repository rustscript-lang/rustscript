...
/// Host function `tls::session::set_client_certificate`.
...
/// Host function `tls::session::set_client_private_key`.
...
/// Host function `tls::session::set_server_certificate`.
...
/// Host function `tls::session::set_server_private_key`.
