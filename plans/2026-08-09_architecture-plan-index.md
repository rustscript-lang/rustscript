...
| HTTP runtime | Special-use address gaps, blocking DNS, unbounded scheduling, deadline/cancel gaps | `2026-08-09_http-transport-security-executor.md` | capability profile and host lifecycle |
...
1. HTTP transport executor/security.
