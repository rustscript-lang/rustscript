...
#[cfg(feature = "runtime")]
pub use vm::{
    AotArtifactError, BoundHostProgram, CallOutcome, CallReturn, CapabilityProfile,
    CapabilityProfileBuilder, CaptureAsyncHostContext, CatalogRegistrationError,
    CatalogSchemaSelection, DEFAULT_MAX_SCRIPT_CALL_DEPTH, EpochCheckpoint, EpochHandle,
    FuelCheckpoint, HostArgsFunction, HostAsyncBridge, HostAsyncOpTerminal, HostBindingPlan,
    HostContext, HostContextError, HostContextErrorKind, HostContextResult, HostExtension,
    HostFunction, HostFunctionRegistry, HostFuture, HostFutureOutput, HostImportParam,
    HostImportSchema, HostModule, HostModuleState, HostOpId, HostStackFunction, HostState,
    HostStateError, HostStateLifetime, HostStateMut, HostStateProvider, HostStateRef,
    HostStateRequirement, HostStateRequirementError, IntoScriptValue, Invocation, InvocationError,
    InvocationItem, InvocationPoll, QueuedScriptInvocation, RegistrySchemaError,
    ...
    VmResult, VmStatus, VmYieldReason, async_host, catalog_import_schemas,
    catalog_import_schemas_into, catalog_named_struct_schemas, execution_scope, host_context,
    host_extension, operation, register_catalog_function, register_catalog_static_function,
    register_host_extension, resource, validate_catalog_import_schemas,
