...
pub(crate) use bridge::{
    ...
    frame_state_entry_address, helper_entry_address, helper_entry_offset,
    init_null_value_slot_entry_address, interrupt_helper_entry_address,
    interrupt_helper_entry_offset, leave_frame_entry_address, make_callable_entry_address,
...
pub(crate) use codegen::{
    ...
    make_callable_signature, map_iter_next_signature, map_iter_take_signature, map_set_signature,
