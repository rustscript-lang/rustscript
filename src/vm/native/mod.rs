...
pub(crate) use bridge::{
    ...
    ROOT_FRAME_KEY, STATUS_CONTINUE, STATUS_ERROR, STATUS_HALTED, STATUS_LINKED_CONTINUE,
    STATUS_OUT_OF_FUEL, STATUS_TRACE_EXIT, STATUS_WAITING, STATUS_YIELDED,
    ...
    collection_set_entry_address, copy_bytes_entry_address, frame_state_entry_address,
    ...
    map_iter_take_value_entry_address, map_set_entry_address, non_yielding_host_call_entry_address,
...
pub(crate) use codegen::{
    ...
    copy_bytes_signature, entry_signature, frame_state_signature, free_buffer_signature,
    helper_signature, jump_with_status, map_iter_next_signature, map_iter_take_signature,
    map_set_signature, non_yielding_host_call_signature, pack_shared_signature,
    regex_match_signature, regex_replace_signature, restore_exit_signature,
...
pub(crate) const NATIVE_CALLABLE_ABI_VERSION: u16 = 1;
