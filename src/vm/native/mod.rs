...
pub(crate) use bridge::{
    ...
    array_push_entry_address, array_set_entry_address, clear_bridge_error,
    clear_value_slot_entry_address, clone_value_to_slot_entry_address,
    collection_set_entry_address, copy_bytes_entry_address, helper_entry_address,
    ...
    map_iter_next_entry_address, map_iter_take_key_entry_address,
    map_iter_take_value_entry_address, map_set_entry_address, non_yielding_host_call_entry_address,
    regex_match_entry_address, regex_replace_entry_address, restore_exit_state_entry_address,
...
pub(crate) use codegen::{
    ...
    jump_with_status, map_iter_next_signature, map_iter_take_signature, map_set_signature,
    non_yielding_host_call_signature, pack_shared_signature, regex_match_signature,
