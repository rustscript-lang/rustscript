...
struct BuiltinNamespaceMemberSpec {
    name: &'static str,
    arity: usize,
    docs: &'static str,
}
...
const RE_MEMBERS: &[BuiltinNamespaceMemberSpec] = &[
    BuiltinNamespaceMemberSpec {
        name: "match",
        arity: 3,
        docs: "Regex match with optional flags argument.",
    },
    BuiltinNamespaceMemberSpec {
        name: "is_match",
        arity: 2,
        docs: "Regex match without explicit flags.",
    },
    BuiltinNamespaceMemberSpec {
        name: "find",
        arity: 2,
        docs: "Find first regex match.",
    },
    BuiltinNamespaceMemberSpec {
        name: "replace",
        arity: 3,
        docs: "Replace regex matches.",
    },
    BuiltinNamespaceMemberSpec {
        name: "split",
        arity: 2,
        docs: "Split text by regex delimiter.",
    },
    BuiltinNamespaceMemberSpec {
        name: "captures",
        arity: 2,
        docs: "Return capture groups.",
    },
];

const JSON_MEMBERS: &[BuiltinNamespaceMemberSpec] = &[
    BuiltinNamespaceMemberSpec {
        name: "encode",
        arity: 1,
        docs: "Serialize value to JSON string.",
    },
    BuiltinNamespaceMemberSpec {
        name: "decode",
        arity: 1,
        docs: "Parse JSON string into VM value.",
    },
];

const IO_MEMBERS: &[BuiltinNamespaceMemberSpec] = &[
    BuiltinNamespaceMemberSpec {
        name: "open",
        arity: 2,
        docs: "Open file handle.",
    },
    BuiltinNamespaceMemberSpec {
        name: "popen",
        arity: 2,
        docs: "Open process handle.",
    },
    BuiltinNamespaceMemberSpec {
        name: "read_all",
        arity: 1,
        docs: "Read full handle contents.",
    },
    BuiltinNamespaceMemberSpec {
        name: "read_line",
        arity: 1,
        docs: "Read single line from handle.",
    },
    BuiltinNamespaceMemberSpec {
        name: "write",
        arity: 2,
        docs: "Write text to handle.",
    },
    BuiltinNamespaceMemberSpec {
        name: "flush",
        arity: 1,
        docs: "Flush handle buffers.",
    },
    BuiltinNamespaceMemberSpec {
        name: "close",
        arity: 1,
