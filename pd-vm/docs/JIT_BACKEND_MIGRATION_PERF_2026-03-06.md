...
cargo test -p pd-vm --release --features cranelift-jit --test perf_tests perf_jit_native_reduces_tight_loop_latency -- --ignored --nocapture
...
cargo test -p pd-vm --release --features cranelift-jit --test perf_tests perf_manual_aes_128_cbc_rustscript_matches_in_interpreter_jit_and_aot -- --ignored --nocapture
